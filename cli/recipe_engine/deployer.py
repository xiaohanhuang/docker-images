...
- kubectl-based deployment of Services, ConfigMaps, and Deployments
...
class ArchitectureDeployer:
    ...
    def deploy(self, dry_run: bool = False) -> Dict[str, Any]:
        ...
        # 4. Apply manifests in order: Services → ConfigMaps → Deployments
        apply_order = ["services", "configmaps", "deployments"]
    ...
    def _manifests_to_yaml(self) -> str:
        ...
        all_manifests = []
        for resource_type in ["services", "configmaps", "deployments"]:
